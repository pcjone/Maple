	...
	<div class="page-header-inner ">
		...
		<div class="page-logo">
			<a href="index.html"> <img
				src="resources/assets/layouts/layout/img/logo.png" alt="logo"
				class="logo-default" />
			</a>
			...
			<ul class="nav navbar-nav pull-right">
						...
						<li>
							<ul class="dropdown-menu-list scroller" style="height: 275px;"
								...
								<li><a href="#"> <span class="photo"> <img
											src="resources/assets/layouts/layout3/img/avatar2.jpg"
								...
								<li><a href="#"> <span class="photo"> <img
											src="resources/assets/layouts/layout3/img/avatar3.jpg"
											class="img-circle" alt="">
								...
								<li><a href="#"> <span class="photo"> <img
											src="resources/assets/layouts/layout3/img/avatar1.jpg"
											class="img-circle" alt="">
				...
				<li class="dropdown dropdown-user"><a href="javascript:;"
					...
					data-hover="dropdown" data-close-others="true"> <img alt=""
						class="img-circle"
						src="resources/assets/layouts/layout/img/avatar3_small.jpg" /> <span
